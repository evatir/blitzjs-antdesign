...
var Commit$2 = function Commit(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(DependencyList, {
...
var Propose = function Propose(_ref) {
  ...
  }), /*#__PURE__*/React.createElement(Newline, null), /*#__PURE__*/React.createElement(ink.Text, {
    bold: true
...
var Commit = function Commit(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ink.Box, {
    flexDirection: "column"
  }, fileCreateOutput ? /*#__PURE__*/React.createElement(React.Fragment, null, fileCreateOutput ? /*#__PURE__*/React.createElement(ink.Text, null, fileCreateOutput) : null, /*#__PURE__*/React.createElement(Newline, null), /*#__PURE__*/React.createElement(ink.Text, {
    bold: true
...
function WelcomeMessage(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(ink.Box, {
    ...
    italic: true
  }, recipeMeta.owner)), /*#__PURE__*/React__default['default'].createElement(Newline, null), /*#__PURE__*/React__default['default'].createElement(ink.Text, {
    bold: true
...
function RecipeRenderer(_ref3) {
  ...
  var _React$useReducer = React__default['default'].useReducer(recipeReducer, _extends({}, initialState, {
  ...
  }) : null, state.current > -1 ? /*#__PURE__*/React__default['default'].createElement(StepExecutor, {
    cliArgs: cliArgs,
...
function addBabelPlugin(program, plugin) {
  findModuleExportsExpressions(program).forEach(function (moduleExportsExpression) {
    j__default['default'](moduleExportsExpression).find(j__default['default'].ObjectProperty, {
      ...
      var pluginExpression = Array.isArray(plugin) ? j__default['default'].arrayExpression([j__default['default'].literal(plugin[0]), j__default['default'].objectExpression(Object.entries(plugin[1]).map(function (_ref) {
        var key = _ref[0],
            value = _ref[1];
        return j__default['default'].objectProperty(j__default['default'].identifier(key), j__default['default'].literal(value));
      }))]) : j__default['default'].literal(plugin);
...
exports.AddDependencyType = type$2;
exports.FileTransformType = type$1;
exports.Frontmatter = Frontmatter;
exports.NewFileType = type;
